...
def main(pred_test, pred_train, pred_cal, dt_test_prefixes, dataset_manager):
...
if __name__ == "__main__":
    ...
    for dataset_name in datasets:
        ...
        df_naive, df_classbalanced, df_adaptive, all_df = main(pred_test, pred_train, pred_cal, dt_test_prefixes, dataset_manager)
