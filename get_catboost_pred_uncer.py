...
dt_train_prefixes.to_pickle(os.path.join(results_dir, dataset_name + "_dt_train_prefixes.pkl"))

dt_test_prefixes = dataset_manager.generate_prefix_data(test, min_prefix_length, max_prefix_length)
dt_test_prefixes.to_pickle(os.path.join(results_dir, dataset_name + "_dt_test_prefixes.pkl"))

dt_val_prefixes = dataset_manager.generate_prefix_data(val, min_prefix_length, max_prefix_length)
dt_val_prefixes.to_pickle(os.path.join(results_dir, dataset_name + "_dt_val_prefixes.pkl"))
...
train_data.to_pickle(os.path.join(results_dir, dataset_name + "_train_data.pkl"))
...
test_data.to_pickle(os.path.join(results_dir, dataset_name + "_test_data.pkl"))
...
valid_data.to_pickle(os.path.join(results_dir, dataset_name + "_valid_data.pkl"))
del X_val
del y_val
